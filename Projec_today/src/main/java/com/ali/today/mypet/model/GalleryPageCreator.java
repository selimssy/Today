...
public class GalleryPageCreator {
	
	private GalleryPageVO paging; // 페이지번호와 한 페이지당 들어갈 게시물 수를 갖고 있는 객체
	...
	public GalleryPageVO getPaging() {
		return paging;
	}

	public void setPaging(GalleryPageVO paging) {
		this.paging = paging;
	}
