							...
							<c:forEach var="dateList" items="${dateList}" varStatus="date_status"> 
								<c:choose>
									...
									<c:when test="${date_status.index%7==6}">
										<td class="sat_day" style="<c:if test='${dateList.value == 1000}'>background-color:aqua</c:if>">
											<div class="sat">
												${dateList.date}
						...
						<tr>	
							<td class="sun_day"  style="<c:if test='${dateList.value == 1000}'>background-color:aqua</c:if>">
								...
								<div>
									...
									<c:otherwise>
							<td class="normal_day" style="<c:if test='${dateList.value == 1000}'>background-color:aqua</c:if>">
								<div class="date">
									${dateList.date}
									<div class="scheduleBox">
										<c:forEach var="scheduleList" items="${dateList.schedule_data_arr}" varStatus="schedule_data_arr_status"> 
